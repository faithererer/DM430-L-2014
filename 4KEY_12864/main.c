  ...
  while(1)
    {
        ...
        {
	  {
            switch(key)
              {
	        case 1: LED8 = 0xFC;LCD_DisplayKey(1);delay_ms(4);break;     //给不同的键赋键值，键值1，亮2个LED灯
                case 2: LED8 = 0xF3;LCD_DisplayKey(2);delay_ms(4);break;     //给不同的键赋键值，键值2，亮2个LED灯
                case 3: LED8 = 0xCF;LCD_DisplayKey(3);delay_ms(4);break;     //给不同的键赋键值，键值3，亮2个LED灯
                case 4: LED8 = 0x3F;LCD_DisplayKey(4);delay_ms(4);break;     //给不同的键赋键值，键值4，亮2个LED灯
              }
