...
函数功能：MMC/SD卡容量显示
***********************************************************************/
void Print_SDSize(ulong Capacity)
{
  static	u16 SizeQ,SizeB,SizeS,SizeG;
  ulong Size;
  LCD_PutString(0,48,"SD Size:",White,Black);  //显示SD卡容量
  Size=Capacity/1024/1024;
  SizeQ=Size/1000;
  SizeB=(Size%1000)/100;
  SizeS=(Size%1000)%100/10;
  SizeG=(Size%1000)%100%10;
  LCD_PutSingleChar(64,48,SizeQ+'0',Red,Black);
  LCD_PutSingleChar(72,48,SizeB+'0',Red,Black);
  LCD_PutSingleChar(80,48,SizeS+'0',Red,Black);
  LCD_PutSingleChar(88,48,SizeG+'0',Red,Black);
  LCD_PutString(96,48,"MB",Red,Black);  	//显示SD卡容量
}