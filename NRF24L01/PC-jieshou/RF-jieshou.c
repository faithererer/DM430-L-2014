/********************************************************************
//DM430-L型最小系统板NRF24L01测试程序，接收端程序，接收成功后LED灯D3闪烁
//接收到的数据通过串口USART0发送到PC端，PC端用串口调试助手在16进制模式下接收
//配套的发送程序发送0x01 02 03……0x32，共32个字节，重复发送，波特率9600
//BSL模块可做USB转串口使用，程序下载到单片机后，请将BSL跳线帽全部取下
//然后将TXD和RXD0，RXD和TXD0连接，即可配置为DM430-M与电脑进行串口通信
//此时BSL无法进行下载，如果要下载，再配置为BSL方式
//调试环境：EW430 V5.30
//作者：www.avrgcc.com
//时间：2014.03.01
********************************************************************/
